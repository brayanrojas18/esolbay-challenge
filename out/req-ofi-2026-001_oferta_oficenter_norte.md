...
|---|---|---|---:|---:|---:|---:|---|
| #5 Cinta adhesiva transparente 48mm | L5 Rollo cinta transparente de embalaje 48 mm | Cantidad parcial | 100 | 120 | +20 | 0.95 | Cinta transparente de embalaje de 48mm coincide en tipo y medida con cinta adhesiva transparente de 48mm.. el proveedor ofrece 120 contra 100 pedidas (20 de mas, probable presentacion comercial) |
...
| #2 Boligrafo azul | L2 Lapicera tinta azul punta media | Coincidencia | 500 | 500 | - | 0.92 | Lapicera de tinta azul punta media es sinónimo de bolígrafo azul.. mismo producto y misma cantidad |
| #1 Resma papel A4 75g | L1 Paquete de papel blanco tamanio A4 75 gramos | Coincidencia | 100 | 100 | - | 0.95 | Un paquete de papel blanco A4 de 75g equivale exactamente a la resma de papel A4 de 75g solicitada.. mismo producto y misma cantidad |
| #3 Carpeta plastica A4 | L3 Folder plastico para hojas A4 | Coincidencia | 200 | 200 | - | 0.95 | Folder plástico para hojas A4 equivale a carpeta plástica A4.. mismo producto y misma cantidad |
| #4 Marcador permanente negro | L4 Rotulador indeleble color negro | Coincidencia | 50 | 50 | - | 0.95 | Rotulador indeleble color negro es equivalente a marcador permanente negro.. mismo producto y misma cantidad |
| #6 Cuaderno tapa dura A4 | L6 Cuaderno A4 con tapa rigida | Coincidencia | 40 | 40 | - | 0.95 | Cuaderno A4 con tapa rígida es sinónimo de cuaderno tapa dura A4.. mismo producto y misma cantidad |
...
| Tokens entrada / salida | 2124 / 1783 |

### Volumen

Conciliar 7 lineas ofertadas contra 6 items solicitados por fuerza bruta serian **42 comparaciones**.

Con el prefiltro vectorial fueron **1 query indexada** (HNSW + distancia coseno, dentro de Postgres) en 569 ms, y el decisor evaluo 5 candidatos por linea en vez de 6.

---

Conciliacion `63eebfdf-8f92-4d6a-9cd4-903797389b34` generada el 26/8/2026, 04:12:59.